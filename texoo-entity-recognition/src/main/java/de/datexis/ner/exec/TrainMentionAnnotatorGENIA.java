 ...
 */
public class TrainMentionAnnotatorGENIA {

  protected final static Logger log = LoggerFactory.getLogger(TrainMentionAnnotatorGENIA.class);
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      parser.parse(args);
      new TrainMentionAnnotatorGENIA().runTraining(params);
      System.exit(0);
  ...
  protected void runTraining(ExecParams params) throws IOException {
    ...
    // Read datasets
    Dataset train = GeniaCorpusReader.readDataset(trainingPath);
    ...
    MentionAnnotator ner = new MentionAnnotator.Builder()
        ...
        .pretrain(train)
        .withModelParams(396, 128)
        .withTrainingParams(0.001, 16, 1)
        .withTypes("MED")
        .build();
