 ...
 * Additional implementation of an option to emit tokens for new line characters.
 * @author Rudolf Schneider
 */
public class NewlineTokenizerME extends TokenizerME {
  ...
  public NewlineTokenizerME(TokenizerModel model) {
    super(model);
  }

  public NewlineTokenizerME(TokenizerModel model, Factory factory) {
    super(model, factory);
  }
