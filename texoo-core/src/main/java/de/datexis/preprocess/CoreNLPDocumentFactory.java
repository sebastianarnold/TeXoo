 ...
 */
public class CoreNLPDocumentFactory {

  protected final static Logger log = LoggerFactory.getLogger(CoreNLPDocumentFactory.class);
  public static final int AVERAGE_ENGLISH_SENTENCE_LENGTH = 14;

  protected static CoreNLPDocumentFactory instance = new CoreNLPDocumentFactory();
  
  public static CoreNLPDocumentFactory getInstance() {
    return instance;
  }
