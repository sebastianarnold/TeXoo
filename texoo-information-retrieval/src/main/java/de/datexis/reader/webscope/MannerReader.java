...
public class MannerReader {
  public static void main(String[] args) throws SAXException, ParserConfigurationException, IOException {
    ...
    objectMapper.writeValue(new File("res/manner_datexis.json"), handler.getDataset());
  }

  public static class MannerHandler extends DefaultHandler {
    private IRDataset dataset = new IRDataset("Manner");
    private Query query;
