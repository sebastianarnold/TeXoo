...
public class SimpleRESTEncoderTest {
  ...
  private SimpleRESTEncoder simpleRESTEncoder;
  ...
  public void setup() throws IOException {
    ...
    simpleRESTEncoder = spy(new DummySimpleRESTEncoder(restAdapter, VECTOR_IDENTIFIER, Token.class));
  ...
  public void getEmbeddingVectorSizeTest(){
    assertThat(simpleRESTEncoder.getEmbeddingVectorSize(), equalTo((long) EMBEDDING_VECTOR_SIZE));
  }

  @Test
  public void encodeImplTest() throws IOException {
    INDArray embedding = simpleRESTEncoder.encodeValue("text");
  ...
  public void getTokensOfSentencesOfDocumentTest(){
    List<List<Token>> tokens2D = simpleRESTEncoder.getTokensOfSentencesOfDocument(dummyDocument);
  ...
  public void encodeEachTest() throws IOException {
    simpleRESTEncoder.encodeEach(dummySpan);
  ...
  public void encodeEachCustomGetTextTest() throws IOException {
    simpleRESTEncoder.encodeEach(dummySpan, DummySpan::customGetText);
  ...
  public void encodeEach1DTest() throws IOException {
    simpleRESTEncoder.encodeEach1D(dummySpan1D);
  ...
  public void encodeEach1DCustomGetTextTest() throws IOException {
    simpleRESTEncoder.encodeEach1D(dummySpan1D, DummySpan::customGetText);
  ...
  public void encodeEach2DTest() throws IOException {
    simpleRESTEncoder.encodeEach2D(dummySpan2D);
  ...
  public void encodeEach2DCustomGetTextTest() throws IOException {
    simpleRESTEncoder.encodeEach2D(dummySpan2D, DummySpan::customGetText);
  ...
  public void spansToStringArray1DTest(){
    String[] spanString1D = simpleRESTEncoder.spansToStringArray1D(dummySpan1D.stream());
  ...
  public void spansToStringArray1DCustomGetTextTest(){
    String[] spanString1D = simpleRESTEncoder.spansToStringArray1D(dummySpan1D.stream(), DummySpan::customGetText);
  ...
  public void spansToStringArray2DTest(){
    ...
    String[][] spanString2D = simpleRESTEncoder.spansToStringArray2D(spanStreams);
  ...
  public void spansToStringArray2DCustomGetTextTest(){
    ...
    String[][] spanString2D = simpleRESTEncoder.spansToStringArray2D(spanStreams, DummySpan::customGetText);
  ...
  public void putVectorInSpanTest(){
    simpleRESTEncoder.putVectorInSpan(dummySpan, dummyVectorSpan);
  ...
  public void putVectorInSpans1D(){
    simpleRESTEncoder.putVectorInSpans(dummySpan1D.stream(), dummyVectorSpan1D);
  ...
  public void putVectorInSpans2D(){
    ...
    simpleRESTEncoder.putVectorInSpans(spanStreams, dummyVectorSpan2D);
