...
public class AbstractRESTAdapterTest {
  ...
  public void configureConnectionTest() throws IOException {
    ...
    assertThat(connection.getRequestProperty(AbstractRESTAdapter.HTTP_ACCEPT_TYPE_NAME), equalTo(DummySerdeProvider.ACCEPT_TYPE));
    assertThat(connection.getRequestProperty(AbstractRESTAdapter.HTTP_CONTENT_TYPE_NAME), equalTo(DummySerdeProvider.CONTENT_TYPE));
