...
/**
 * This Decoder capsules a Sentence Embedding
 * @author Sebastian Arnold <sarnold@beuth-hochschule.de>
 */
public class LSTMSentenceEncoder extends Annotator implements IEncoder {
  ...
  public LSTMSentenceEncoder(Tagger root) {
    super(root);
  }
  
  protected LSTMSentenceEncoder(AnnotatorComponent comp) {
    super(comp);
  }
  ...
  /**
   * Encodes a batch of Sentences into a matrix using a forward pass.
   * @param spans the Sentences to encode
   * @return vector for the Sentence
   */
  @Override
  public INDArray encode(Iterable<? extends Span> spans) {
    throw new UnsupportedOperationException("Batch encoding is not implemented yet.");
  }
  
  public static class Builder {
    
    LSTMSentenceEncoder ann;
    ...
    public Builder() {
      ...
      ann = new LSTMSentenceEncoder(tagger);
    }
    ...
    public LSTMSentenceEncoder build() {
